    ...
    <div class="table-wrapper">
        <table>
            ...
            <tr>
                ...
                <td><code>Harbor\Command</code></td>
                <td>Loads standalone command flag helpers (<code>command_flags_init()</code>, <code>command_flag_present()</code>, <code>command_flag()</code>, <code>command_flags_print_usage()</code>).</td>
            </tr>
            <tr>
